...
public class AnimationUtils {
     ...
     * @param listener
     */
    public static void setAddTaskAnimation(Activity activity, View startView, View targetView,
                                           final AddTaskAnimationListener listener){

        //1.创建遮罩动画层
        ViewGroup animMaskLayout = createAnimLayout(activity);//LinearLayout
        ...
        //3.设置遮罩层的ImageView的LayoutParams
